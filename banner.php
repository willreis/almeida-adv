	...
	<div class="slider-1">
		<div id="layerslider" class="ls-wp-container fitvidsignore" style="width:1180px;height:425px;margin:0 auto;margin-bottom: 0;z-index:5;">
			<div class="ls-slide" data-ls="duration:10000;transition2d:70;timeshift:-3200;kenburnsscale:1.2;">
				...
				<h2 style="padding-top:180px!important;left:90px;text-align:initial;font-weight:400;font-style:normal;text-decoration:none;word-wrap:normal;opacity:1;font-family:Gudea;font-size:22px;color:#ffffff;" class="ls-l ls-hide-phone" data-ls="showinfo:1;offsetxin:-100lw;durationin:800;delayin:1700;easingin:easeInOutBack;offsetxout:-100lw;durationout:800;startatout:transitioninend + 4400;easingout:easeInBack;clipout:0 100% 0 0;position:fixed;">
					Todos são qualificados em diversas áreas do direito.
				</h2>
			</div>
			...
			<div class="ls-slide" data-ls="duration:10000;transition2d:70;timeshift:-3200;kenburnsscale:1.2;">
				...
				<h2 style="padding-top:180px!important;left:90px;text-align:initial;font-weight:400;font-style:normal;text-decoration:none;word-wrap:normal;opacity:1;font-family:Gudea;font-size:22px;color:#ffffff;" class="ls-l ls-hide-phone" data-ls="showinfo:1;offsetxin:-100lw;durationin:800;delayin:1700;easingin:easeInOutBack;offsetxout:-100lw;durationout:800;startatout:transitioninend + 4400;easingout:easeInBack;clipout:0 100% 0 0;position:fixed;">
					Fale conosco, temos a experiência que seu caso precisa.
				</h2>
			</div>
			<div class="ls-slide" data-ls="duration:10000;transition2d:70;timeshift:-3200;kenburnsscale:1.2;">
				...
				<h2 style="padding-top:180px!important;left:90px;text-align:initial;font-weight:400;font-style:normal;text-decoration:none;word-wrap:normal;opacity:1;font-family:Gudea;font-size:22px;color:#ffffff;" class="ls-l ls-hide-phone" data-ls="showinfo:1;offsetxin:-100lw;durationin:800;delayin:1700;easingin:easeInOutBack;offsetxout:-100lw;durationout:800;startatout:transitioninend + 4400;easingout:easeInBack;clipout:0 100% 0 0;position:fixed;">
					Ao longo dos anos nos tornamos<br>referência no segmento
				</h2>
			</div>
		</div>
	</div>
						...
						<a href="sobre-nos.php">
							<div class="services-links__column">
								...
								<div class="services-links__item">
									<h2 class="services-links__title">Sobre Nós</h2>
									<p class="services-links__item-content">Confira mais sobre nós</p>
								</div>
							</div>
						</a>
					</div>
					<div class="columns small-12 large-4">
						<a href="servicos.php">
							<div class="services-links__column">
								...
								<div class="services-links__item">
									<h2 class="services-links__title">Serviços</h2>
									<p class="services-links__item-content">Confira mais sobre os nossos serviços</p>
								</div>
							</div>
						</a>
					</div>
					<div class="columns small-12 large-4">
						<a href="contato.php">
							<div class="services-links__column">
								...
								<div class="services-links__item">
									<h2 class="services-links__title">Contato</h2>
									<p class="services-links__item-content">Entre em contato conosco</p>
								</div>
							</div>
						</a>
					</div>
